...
async def save_transaction_id(
    engine: Engine, params: SaveTransactionId
) -> TransactionId:
    """
    Save Transaction ID.
    """
    new_transaction_id = TransactionId(transaction_id=params.transaction_id)
